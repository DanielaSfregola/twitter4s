...
private[twitter4s] case class RelationshipParametersByIds(source_id: Long,
                                                          target_id: Long) extends RelationshipParameters

private[twitter4s] case class RelationshipParametersByNames(source_screen_name: String,
