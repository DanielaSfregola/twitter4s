...
trait TwitterApplicationClient extends OAuthClient with Configurations {
  ...
  /** Returns the current rate limits for methods belonging to the specified resource families.
    ...
    * <a href="https://dev.twitter.com/rest/reference/get/application/rate_limit_status">https://dev.twitter.com/rest/reference/get/application/rate_limit_status</a>
    *
