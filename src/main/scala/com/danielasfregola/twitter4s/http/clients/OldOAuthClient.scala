...
import com.danielasfregola.twitter4s.http.oauth.OldOAuth2Provider
import com.danielasfregola.twitter4s.providers.{ActorSystemProvider, TokenProvider}

import scala.concurrent.Future

private[twitter4s] trait OldOAuthClient extends OldCommonClient with TokenProvider with ActorSystemProvider with RequestBuilding {

  protected lazy val oauthProvider = new OldOAuth2Provider(consumerToken, accessToken)
