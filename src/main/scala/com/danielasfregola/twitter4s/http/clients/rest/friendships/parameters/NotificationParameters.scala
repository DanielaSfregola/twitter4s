...
private[twitter4s] case class RetweetNotificationParameters(user_id: Option[Long],
                                                            screen_name: Option[String],
                                                            retweets: Boolean) extends NotificationParameters

private[twitter4s] case class DeviceNotificationParameters(user_id: Option[Long],
                                                           screen_name: Option[String],
