...
trait Clients extends TwitterStatusClient with TwitterDirectMessageClient
  with TwitterFriendshipClient with TwitterFollowerClient with TwitterFriendClient
